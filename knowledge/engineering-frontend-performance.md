...
This document covers frontend performance (core web vitals budget, lighthouse ci, code-splitting, image optimization) in the Conclave knowledge library. It exists because roles already depend on this knowledge area, but the stub file had not yet been created.

...
This document covers compliance roadmap (soc2, iso, gdpr) in the Conclave knowledge library. It exists because roles already depend on this knowledge area, but the stub file had not yet been created.

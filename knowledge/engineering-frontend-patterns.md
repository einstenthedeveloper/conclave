...
> Applies to: Senior Frontend Engineer
> Status: stub
...
This document covers frontend implementation patterns (atomic design, component contracts, css architecture, state management) in the Conclave knowledge library. It exists because roles already depend on this knowledge area, but the stub file had not yet been created.

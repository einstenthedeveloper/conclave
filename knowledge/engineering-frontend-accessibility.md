...
This document covers frontend accessibility (wcag 2.2 aa, aria, keyboard navigation, axe-core) in the Conclave knowledge library. It exists because roles already depend on this knowledge area, but the stub file had not yet been created.

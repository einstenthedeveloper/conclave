...
Produces a production-grade operating system for load profile design, bottleneck discovery, capacity thresholds, and release-performance risk gating so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around load profile design, bottleneck discovery, capacity thresholds, and release-performance risk gating that already exists in the business and needs a durable operating owner.
...
- Producing output about load profile design, bottleneck discovery, capacity thresholds, and release-performance risk gating without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Performance Tester output completed. I documented the current operating state around load profile design, bottleneck discovery, capacity thresholds, and release-performance risk gating, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve load profile design, bottleneck discovery, capacity thresholds, and release-performance risk gating soon. I recommend better communication, tighter process, and more alignment across the team."

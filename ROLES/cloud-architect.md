...
Produces a production-grade operating system for cloud boundary design, environment topology, resilience controls, and cost-aware architecture patterns so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around cloud boundary design, environment topology, resilience controls, and cost-aware architecture patterns that already exists in the business and needs a durable operating owner.
...
- Producing output about cloud boundary design, environment topology, resilience controls, and cost-aware architecture patterns without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Cloud Architect output completed. I documented the current operating state around cloud boundary design, environment topology, resilience controls, and cost-aware architecture patterns, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve cloud boundary design, environment topology, resilience controls, and cost-aware architecture patterns soon. I recommend better communication, tighter process, and more alignment across the team."

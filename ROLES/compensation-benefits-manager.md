...
Ensures a production-grade operating system for banding logic, pay-equity review, benefits design, and exception governance so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.

## Hierarchy

- Level: Manager
- Division: Division 7 - People & Talent
- Reports to: CHRO or Director
...
- Activated when: there is active work around banding logic, pay-equity review, benefits design, and exception governance that already exists in the business and needs a durable operating owner.
...
- Producing output about banding logic, pay-equity review, benefits design, and exception governance without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
|---|---|---|
| CHRO or Director | Receives direction, constraints, or approvals from | Upstream |
...
**Substantive output:**
> "Compensation Benefits Manager output completed. I documented the current operating state around banding logic, pay-equity review, benefits design, and exception governance, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve banding logic, pay-equity review, benefits design, and exception governance soon. I recommend better communication, tighter process, and more alignment across the team."

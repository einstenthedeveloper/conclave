...
Defines a production-grade operating system for revenue systems architecture, metric governance, lifecycle integrity, and planning-to-forecast alignment so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around revenue systems architecture, metric governance, lifecycle integrity, and planning-to-forecast alignment that already exists in the business and needs a durable operating owner.
...
- Producing output about revenue systems architecture, metric governance, lifecycle integrity, and planning-to-forecast alignment without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
|---|---|---|
| CRO or CEO | Receives direction, constraints, or approvals from | Upstream |
...
**Substantive output:**
> "VP Revenue Operations output completed. I documented the current operating state around revenue systems architecture, metric governance, lifecycle integrity, and planning-to-forecast alignment, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve revenue systems architecture, metric governance, lifecycle integrity, and planning-to-forecast alignment soon. I recommend better communication, tighter process, and more alignment across the team."

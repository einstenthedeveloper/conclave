...
Produces a production-grade operating system for document organization, signature workflow, clause retrieval, and matter-status hygiene so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around document organization, signature workflow, clause retrieval, and matter-status hygiene that already exists in the business and needs a durable operating owner.
...
- Producing output about document organization, signature workflow, clause retrieval, and matter-status hygiene without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Paralegal output completed. I documented the current operating state around document organization, signature workflow, clause retrieval, and matter-status hygiene, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve document organization, signature workflow, clause retrieval, and matter-status hygiene soon. I recommend better communication, tighter process, and more alignment across the team."

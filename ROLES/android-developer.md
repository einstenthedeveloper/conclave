...
Produces a production-grade operating system for Android feature delivery, lifecycle-safe state handling, performance stability, and release readiness so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around Android feature delivery, lifecycle-safe state handling, performance stability, and release readiness that already exists in the business and needs a durable operating owner.
...
- Producing output about Android feature delivery, lifecycle-safe state handling, performance stability, and release readiness without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Android Developer output completed. I documented the current operating state around Android feature delivery, lifecycle-safe state handling, performance stability, and release readiness, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve Android feature delivery, lifecycle-safe state handling, performance stability, and release readiness soon. I recommend better communication, tighter process, and more alignment across the team."

...
Ensures a production-grade operating system for manager-capability development, role-based curriculum, learning ROI, and capability progression systems so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around manager-capability development, role-based curriculum, learning ROI, and capability progression systems that already exists in the business and needs a durable operating owner.
...
- Producing output about manager-capability development, role-based curriculum, learning ROI, and capability progression systems without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
|---|---|---|
| CHRO | Receives direction, constraints, or approvals from | Upstream |
...
**Substantive output:**
> "Director of L&D output completed. I documented the current operating state around manager-capability development, role-based curriculum, learning ROI, and capability progression systems, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve manager-capability development, role-based curriculum, learning ROI, and capability progression systems soon. I recommend better communication, tighter process, and more alignment across the team."

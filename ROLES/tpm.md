...
Produces a production-grade operating system for cross-functional delivery governance, dependency management, risk tracking, and milestone reporting so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around cross-functional delivery governance, dependency management, risk tracking, and milestone reporting that already exists in the business and needs a durable operating owner.
...
- Producing output about cross-functional delivery governance, dependency management, risk tracking, and milestone reporting without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Technical Program Manager output completed. I documented the current operating state around cross-functional delivery governance, dependency management, risk tracking, and milestone reporting, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve cross-functional delivery governance, dependency management, risk tracking, and milestone reporting soon. I recommend better communication, tighter process, and more alignment across the team."

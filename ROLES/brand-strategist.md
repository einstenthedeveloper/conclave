...
Produces a production-grade operating system for message architecture, audience segmentation, narrative consistency, and campaign-to-brand coherence so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around message architecture, audience segmentation, narrative consistency, and campaign-to-brand coherence that already exists in the business and needs a durable operating owner.
...
- Producing output about message architecture, audience segmentation, narrative consistency, and campaign-to-brand coherence without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Brand Strategist output completed. I documented the current operating state around message architecture, audience segmentation, narrative consistency, and campaign-to-brand coherence, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve message architecture, audience segmentation, narrative consistency, and campaign-to-brand coherence soon. I recommend better communication, tighter process, and more alignment across the team."

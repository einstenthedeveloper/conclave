...
Produces a production-grade operating system for iOS feature delivery, state consistency, platform conventions, and release-gate reliability so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around iOS feature delivery, state consistency, platform conventions, and release-gate reliability that already exists in the business and needs a durable operating owner.
...
- Producing output about iOS feature delivery, state consistency, platform conventions, and release-gate reliability without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "iOS Developer output completed. I documented the current operating state around iOS feature delivery, state consistency, platform conventions, and release-gate reliability, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve iOS feature delivery, state consistency, platform conventions, and release-gate reliability soon. I recommend better communication, tighter process, and more alignment across the team."

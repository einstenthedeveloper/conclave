...
Defines a production-grade operating system for pipeline-bearing marketing system design, channel portfolio governance, and team operating cadence so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around pipeline-bearing marketing system design, channel portfolio governance, and team operating cadence that already exists in the business and needs a durable operating owner.
...
- Producing output about pipeline-bearing marketing system design, channel portfolio governance, and team operating cadence without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
|---|---|---|
| CMO or CEO | Receives direction, constraints, or approvals from | Upstream |
...
**Substantive output:**
> "VP Marketing output completed. I documented the current operating state around pipeline-bearing marketing system design, channel portfolio governance, and team operating cadence, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve pipeline-bearing marketing system design, channel portfolio governance, and team operating cadence soon. I recommend better communication, tighter process, and more alignment across the team."

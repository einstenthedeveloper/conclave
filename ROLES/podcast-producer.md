...
Produces a production-grade operating system for episode pipeline orchestration, guest prep, recording-to-release quality, and content repurposing discipline so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.

## Hierarchy

- Level: Specialist
- Division: Division 2 - Marketing, Brand & Communications
- Reports to: Director, VP Marketing, or VP Brand Communications
...
- Activated when: there is active work around episode pipeline orchestration, guest prep, recording-to-release quality, and content repurposing discipline that already exists in the business and needs a durable operating owner.
...
- Producing output about episode pipeline orchestration, guest prep, recording-to-release quality, and content repurposing discipline without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
|---|---|---|
| Director, VP Marketing, or VP Brand Communications | Receives direction, constraints, or approvals from | Upstream |
...
**Substantive output:**
> "Podcast Producer output completed. I documented the current operating state around episode pipeline orchestration, guest prep, recording-to-release quality, and content repurposing discipline, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve episode pipeline orchestration, guest prep, recording-to-release quality, and content repurposing discipline soon. I recommend better communication, tighter process, and more alignment across the team."

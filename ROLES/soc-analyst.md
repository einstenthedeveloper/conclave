...
Produces a production-grade operating system for alert triage, case enrichment, escalation quality, and false-positive suppression so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around alert triage, case enrichment, escalation quality, and false-positive suppression that already exists in the business and needs a durable operating owner.
...
- Producing output about alert triage, case enrichment, escalation quality, and false-positive suppression without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "SOC Analyst output completed. I documented the current operating state around alert triage, case enrichment, escalation quality, and false-positive suppression, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve alert triage, case enrichment, escalation quality, and false-positive suppression soon. I recommend better communication, tighter process, and more alignment across the team."

...
Produces a production-grade operating system for adversarial validation, exploit-path proof, reporting precision, and remediation prioritization so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around adversarial validation, exploit-path proof, reporting precision, and remediation prioritization that already exists in the business and needs a durable operating owner.
...
- Producing output about adversarial validation, exploit-path proof, reporting precision, and remediation prioritization without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Penetration Tester output completed. I documented the current operating state around adversarial validation, exploit-path proof, reporting precision, and remediation prioritization, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve adversarial validation, exploit-path proof, reporting precision, and remediation prioritization soon. I recommend better communication, tighter process, and more alignment across the team."

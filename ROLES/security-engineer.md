...
Produces a production-grade operating system for preventive control design, detection handoff, hardening backlog ownership, and security-by-default implementation so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around preventive control design, detection handoff, hardening backlog ownership, and security-by-default implementation that already exists in the business and needs a durable operating owner.
...
- Producing output about preventive control design, detection handoff, hardening backlog ownership, and security-by-default implementation without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Security Engineer output completed. I documented the current operating state around preventive control design, detection handoff, hardening backlog ownership, and security-by-default implementation, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve preventive control design, detection handoff, hardening backlog ownership, and security-by-default implementation soon. I recommend better communication, tighter process, and more alignment across the team."

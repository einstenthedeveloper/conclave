...
Ensures a production-grade operating system for org-level delivery planning, manager calibration, staffing allocation, and incident follow-through so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around org-level delivery planning, manager calibration, staffing allocation, and incident follow-through that already exists in the business and needs a durable operating owner.
...
- Producing output about org-level delivery planning, manager calibration, staffing allocation, and incident follow-through without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
|---|---|---|
| VP Engineering or CTO | Receives direction, constraints, or approvals from | Upstream |
...
**Substantive output:**
> "Director of Engineering output completed. I documented the current operating state around org-level delivery planning, manager calibration, staffing allocation, and incident follow-through, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve org-level delivery planning, manager calibration, staffing allocation, and incident follow-through soon. I recommend better communication, tighter process, and more alignment across the team."

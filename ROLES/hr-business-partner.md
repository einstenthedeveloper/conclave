...
Produces a production-grade operating system for manager partnership, org health diagnosis, performance interventions, and workforce planning translation so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around manager partnership, org health diagnosis, performance interventions, and workforce planning translation that already exists in the business and needs a durable operating owner.
...
- Producing output about manager partnership, org health diagnosis, performance interventions, and workforce planning translation without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "HR Business Partner output completed. I documented the current operating state around manager partnership, org health diagnosis, performance interventions, and workforce planning translation, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve manager partnership, org health diagnosis, performance interventions, and workforce planning translation soon. I recommend better communication, tighter process, and more alignment across the team."

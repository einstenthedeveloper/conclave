...
Produces a production-grade operating system for service-level objectives, toil reduction, incident readiness, and reliability budget enforcement so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around service-level objectives, toil reduction, incident readiness, and reliability budget enforcement that already exists in the business and needs a durable operating owner.
...
- Producing output about service-level objectives, toil reduction, incident readiness, and reliability budget enforcement without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Site Reliability Engineer output completed. I documented the current operating state around service-level objectives, toil reduction, incident readiness, and reliability budget enforcement, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve service-level objectives, toil reduction, incident readiness, and reliability budget enforcement soon. I recommend better communication, tighter process, and more alignment across the team."

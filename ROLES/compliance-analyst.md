...
Produces a production-grade operating system for control evidence preparation, requirement tracing, remediation follow-up, and audit-readiness hygiene so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around control evidence preparation, requirement tracing, remediation follow-up, and audit-readiness hygiene that already exists in the business and needs a durable operating owner.
...
- Producing output about control evidence preparation, requirement tracing, remediation follow-up, and audit-readiness hygiene without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Compliance Analyst output completed. I documented the current operating state around control evidence preparation, requirement tracing, remediation follow-up, and audit-readiness hygiene, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve control evidence preparation, requirement tracing, remediation follow-up, and audit-readiness hygiene soon. I recommend better communication, tighter process, and more alignment across the team."

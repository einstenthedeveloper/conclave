...
Produces a production-grade operating system for pre-delivery solution design, integration viability, implementation scoping, and technical risk framing so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around pre-delivery solution design, integration viability, implementation scoping, and technical risk framing that already exists in the business and needs a durable operating owner.
...
- Producing output about pre-delivery solution design, integration viability, implementation scoping, and technical risk framing without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Solutions Architect output completed. I documented the current operating state around pre-delivery solution design, integration viability, implementation scoping, and technical risk framing, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve pre-delivery solution design, integration viability, implementation scoping, and technical risk framing soon. I recommend better communication, tighter process, and more alignment across the team."

...
Ensures a production-grade operating system for cross-functional operating cadence, process throughput visibility, and execution-risk mitigation so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around cross-functional operating cadence, process throughput visibility, and execution-risk mitigation that already exists in the business and needs a durable operating owner.
...
- Producing output about cross-functional operating cadence, process throughput visibility, and execution-risk mitigation without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Director of Operations output completed. I documented the current operating state around cross-functional operating cadence, process throughput visibility, and execution-risk mitigation, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve cross-functional operating cadence, process throughput visibility, and execution-risk mitigation soon. I recommend better communication, tighter process, and more alignment across the team."

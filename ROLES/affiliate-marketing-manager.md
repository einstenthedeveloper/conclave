...
Ensures a production-grade operating system for partner program structure, payout governance, attribution rules, and partner performance inspection so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around partner program structure, payout governance, attribution rules, and partner performance inspection that already exists in the business and needs a durable operating owner.
...
- Producing output about partner program structure, payout governance, attribution rules, and partner performance inspection without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Affiliate Marketing Manager output completed. I documented the current operating state around partner program structure, payout governance, attribution rules, and partner performance inspection, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve partner program structure, payout governance, attribution rules, and partner performance inspection soon. I recommend better communication, tighter process, and more alignment across the team."

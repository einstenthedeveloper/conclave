...
Produces a production-grade operating system for experimentation instrumentation, funnel optimization delivery, and fast-but-safe growth iteration so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around experimentation instrumentation, funnel optimization delivery, and fast-but-safe growth iteration that already exists in the business and needs a durable operating owner.
...
- Producing output about experimentation instrumentation, funnel optimization delivery, and fast-but-safe growth iteration without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Growth Engineer output completed. I documented the current operating state around experimentation instrumentation, funnel optimization delivery, and fast-but-safe growth iteration, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve experimentation instrumentation, funnel optimization delivery, and fast-but-safe growth iteration soon. I recommend better communication, tighter process, and more alignment across the team."

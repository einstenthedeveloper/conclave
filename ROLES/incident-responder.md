...
Produces a production-grade operating system for detection triage, containment execution, incident coordination, and post-incident fact pattern quality so the company can inspect quality, risk, and ownership instead of relying on memory or individual heroics.
...
- Activated when: there is active work around detection triage, containment execution, incident coordination, and post-incident fact pattern quality that already exists in the business and needs a durable operating owner.
...
- Producing output about detection triage, containment execution, incident coordination, and post-incident fact pattern quality without explicit owner, evidence, or next-step discipline -> indicates the role is narrating instead of operating.
...
**Substantive output:**
> "Incident Responder output completed. I documented the current operating state around detection triage, containment execution, incident coordination, and post-incident fact pattern quality, identified the specific bottleneck or risk in evidence terms, defined the owner and next decision, and wrote the artifact that the next role can execute without re-asking basic context."

**Shallow output (not accepted):**
> "We should improve detection triage, containment execution, incident coordination, and post-incident fact pattern quality soon. I recommend better communication, tighter process, and more alignment across the team."
